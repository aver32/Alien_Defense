...
namespace Alien_Defense
{
    ...
    /// Меню проигрыша
    /// </summary>
    public class LossGameState : State
    {
        private List<Button> _buttons;
        private ButtonView _buttonView;
        private BackgroundView _backgroundView;
        private FontView _fontView;
        public override StateGame StateName { get => StateGame.Loss; set => throw new NotImplementedException(); }
        public LossGameState(GameCycle game, GraphicsDevice graphicsDevice, ContentManager content)
